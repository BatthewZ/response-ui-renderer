 ...
 */
export declare const COMPONENT_TYPED_ICON_SLOTS: ReadonlySet<string>;
/** Components named by COMPONENT_TYPED_ICON_SLOTS, for the drift test. */
export declare const COMPONENT_TYPED_ICON_OWNERS: readonly string[];
export declare function wantsIconComponent(componentName: string, propName: string): boolean;
//# sourceMappingURL=icon-slots.d.ts.map