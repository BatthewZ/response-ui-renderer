//#region src/registry/icon-slots.ts
/**
...
*/
var COMPONENT_TYPED_ICON_SLOTS = /* @__PURE__ */ new Set(["AppShell.SidebarLink.icon"]);
/** Components named by COMPONENT_TYPED_ICON_SLOTS, for the drift test. */
var COMPONENT_TYPED_ICON_OWNERS = ["AppShell.SidebarLink"];
function wantsIconComponent(componentName, propName) {
	return COMPONENT_TYPED_ICON_SLOTS.has(`${componentName}.${propName}`);
}
//#endregion
export { COMPONENT_TYPED_ICON_OWNERS, COMPONENT_TYPED_ICON_SLOTS, wantsIconComponent };

//# sourceMappingURL=icon-slots.js.map