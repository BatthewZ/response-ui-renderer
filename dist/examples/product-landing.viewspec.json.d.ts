declare const _default: {
  ...
  "description": "A marketing landing page with hero section, feature cards, and call-to-action",
  "data": {
    "features": {
      "type": "static",
      "value": [
    ...
    "showCta": { "type": "static", "value": true }
  },
  "root": {
    "component": "Stack",
    "props": { "gap": "r1" },
    "children": [
      {
        "component": "Hero",
        "props": { "size": "md", "overlay": true, "align": "center" },
        "children": [
          {
            "component": "Hero.Background",
            "props": { "src": "https://picsum.photos/seed/hero-landing/1600/900", "parallax": true }
          },
          {
            "component": "Hero.Content",
            "props": { "animate": true, "animation": "fade-up" },
            "children": [
              {
                "component": "Stack",
                "props": { "gap": "r4" },
                "children": [
                  {
                    "component": "Text",
                    "props": { "variant": "h1", "color": "inverse" },
                    "children": ["Build Beautiful UIs"]
                  },
                  {
                    "component": "Text",
                    "props": { "variant": "body-1", "color": "inverse" },
                      ...
                      "children": [
                        {
                          ...
                          "props": {
                            "variant": "primary",
                            "size": "lg",
                            "onClick": { "action": "showToast", "payload": { "message": "Welcome aboard!", "variant": "info" } }
                          },
                          "children": ["Get Started"]
                        },
                        {
                          "component": "Button",
                          "props": { "variant": "ghost-inverse", "size": "lg" },
                          "children": ["Learn More"]
                        }
                      ]
                    }
        ...
        "children": [
          {
            ...
            "children": [
              ...
              },
              {
                ...
                "props": { "columns": { "base": 1, "md": 3 }, "gap": "var(--spacing-r4)", "animate": true },
                "children": [
                  {
                    "$each": "data.features",
                    "as": "feature",
