 ...
 */
export declare const FIELD_BINDING_KEY = "$field";
export type FieldBinding = {
    $field: string;
};
export type EventAction = "submitForm" | "resetForm" | "navigate" | "showToast" | "apiCall" | "openDialog" | "closeDialog" | "setState";
...
export declare const isRefNode: (n: ViewNode) => n is RefNode;
export declare const isEachNode: (n: ViewNode) => n is EachNode;
export declare const isCondNode: (n: ViewNode) => n is CondNode;
export declare const isComponentNode: (n: ViewNode) => n is ComponentNode;
export declare const isFieldBinding: (v: unknown) => v is FieldBinding;
export declare const isRefValue: (v: unknown) => v is RefNode;
export declare const isEventHandlerSpec: (v: unknown) => v is EventHandlerSpec;
