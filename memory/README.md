...
| [gates.md](gates.md) | Every hand-maintained list in this package and the test that keeps it honest, plus the source-hygiene gates, what upgrading the peer library actually requires, and why an upstream behaviour change can leave every gate green while only the prose needs to move |
