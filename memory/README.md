...
| [testing.md](testing.md) | How to run the suite, what jsdom lacks — including the top layer and `inert`, which makes overlay coverage look wider than it is — and how to avoid writing a check that cannot fail |
